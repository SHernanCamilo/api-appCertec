 ...
 *
 * humtal_tipos_recargo: cat+ílogo de tipos de recargo/hora extra con porcentaje.
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Par+ímetros de jornada (topes + franjas diurna/nocturna, versionados)
        Schema::create('humtal_parametros_jornada', function (Blueprint $table) {
            ...
            $table->boolean('activo')->default(true);
            $table->text('observacion')->nullable()->comment('Ej: Ley 2101 de 2021 - reducci+¦n progresiva');
            $table->timestamps();
