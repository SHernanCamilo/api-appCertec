...
/**
 * Vista equivalente a digipharma.vista_compras_recepcion para recepción técnica.
 * JOIN: inv_orden_compra_detalles + inv_ordenes_compra + inv_pedido_detalles + inv_pedidos
 */
return new class extends Migration
{
    public function up(): void
    {
        DB::statement('DROP VIEW IF EXISTS vista_inv_compras_recepcion');
