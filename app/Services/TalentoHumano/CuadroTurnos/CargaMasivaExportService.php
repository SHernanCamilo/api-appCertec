...
class CargaMasivaExportService
{
    ...
    /**
     * Hoja 1: Llenado rapido ��� una columna "TURNO TODO EL MES" por empleado.
     */
    private function crearHojaLlenadoRapido(
        ...
        foreach ($empleados as $i => $emp) {
            ...
            $validation->setErrorTitle('C+�digo invalido');
        ...
        // Ocultar columna ID (B) ��� es para referencia interna
    ...
    /**
     * Hoja 2: Detalle por dia ��� matriz empleados +� dias del mes.
     */
    private function crearHojaDetalleDia(
        ...
        // Header
        $sheet->setCellValue('A1', "DETALLE POR DIA ��� {$unidad->nombre} ��� {$nombreMes}");
    ...
    /**
     * Hoja 3: Codigos validos ��� referencia de plantillas disponibles.
     */
