...
/**
 * Servicio +¦nico para consultar empleados de una unidad funcional.
 *
 * REGLA: Este es el +ÜNICO lugar donde se consultan empleados por unidad.
...
class EmpleadosUnidadService
{
     ...
     * - Users del sistema (config_unidades_fun_usuarios ÔåÆ users)
     * - Terceros externos (config_unidades_fun_terceros ÔåÆ config_person_tercero)
     */
    ...
    /**
     * Guarda un mapeo texto-tercero ÔåÆ unidad funcional propia.
     */
    ...
    /**
     * Lista unidades del tenant que a+¦n NO tienen mapeo.
     */
