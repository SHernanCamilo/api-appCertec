...
class FrecuenciaController extends Controller
{
    ...
    public function generar(int $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => "Generaci+¦n completada: {$resultado['total_ok']} exitosas, {$resultado['total_err']} errores.",
                'data'    => [
    ...
    public function generarDirecto(Request $request): JsonResponse
    {
        ...
        try {
            ...
            \Log::info('Frecuencia creada, iniciando generaci+¦n', [
                'id' => $frecuencia->id,
    ...
    public function previsualizar(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json(['success' => false, 'message' => 'Error en previsualizaci+¦n: ' . $e->getMessage()], 422);
        }
    }
