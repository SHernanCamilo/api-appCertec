...
class InvOrdenCompraDetalle extends Model
{
    ...
    protected $fillable = [
        'compra_id', 'pedido_detalle_id', 'clasificacion_venta', 'proveedor',
        'cantidad_solicitada_compra', 'fecha_entrega_estimada', 'clasificacion_vie',
        'precio_unitario_compra', 'observaciones', 'estado'
    ];
